...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover Space Box, a premium gaming and entertainment destination in La Marsa, Tunisia." },
      { name: "author", content: "Space Box" },
      { property: "og:title", content: "Space Box — Level Up Your Experience" },
      { property: "og:description", content: "Gaming, competition and entertainment — all in one place in La Marsa." },
